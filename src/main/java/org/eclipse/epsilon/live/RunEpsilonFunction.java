...
public class RunEpsilonFunction extends EpsilonLiveFunction {
	...
	public void run(String language, String program, String secondProgram, String flexmi, String emfatic, String secondFlexmi, String secondEmfatic, OutputStream outputStream, JsonObject response) throws Exception {
